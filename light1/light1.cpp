...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "light1", nullptr, nullptr);
	...
	Shader lightingShader("vertexShaderSource.vs", "fragmentShaderSource.frag");
	Shader lightingShader_lamp("vertexShaderSource.vs", "fragmentShaderSource_lamp.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//set light ambient/diffuse/speculars
		...
		glm::mat4 view;
		camera.Jump_Movement(deltaTime);
		...
		lightingShader_lamp.Use();
		// Get location objects for the matrices on the lamp shader (these could be different on a different shader)
		modelLoc = glGetUniformLocation(lightingShader_lamp.Program, "model");
		viewLoc = glGetUniformLocation(lightingShader_lamp.Program, "view");
		projLoc = glGetUniformLocation(lightingShader_lamp.Program, "projection");
		// Set matrices
		glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(view));
		glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));
